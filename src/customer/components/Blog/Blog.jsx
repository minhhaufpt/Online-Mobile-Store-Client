    ...
    <div>
      <section className="flex items-center py-16 bg-white lg:py-20 font-poppins dark:bg-gray-900 ">
        <div className="justify-center flex-1 max-w-3xl px-4 py-4 mx-auto text-left lg:py-10 ">
          ...
          <div className="grid grid-cols-1 mb-6 md:grid-cols-[40%,1fr] border-gray-200 rounded-md border dark:border-gray-800  gap-2">
            ...
            <div className="px-4 py-4 lg:px-2 ">
              ...
              <p className="mb-4 text-sm text-gray-500 dark:text-gray-400">
                Exploring the latest trends in mobile technology, including
                advancements in hardware, software, and user experience.
              </p>
          ...
          <div className="grid grid-cols-1 mb-6 md:grid-cols-[40%,1fr] border-gray-200 border-b dark:border-gray-700 pb-4 gap-4">
            <div>
              <img
                src="https://i.postimg.cc/MKrLbcmm/pexels-max-fischer-5212345.jpg"
                alt=""
            ...
            <div>
              <a
                href="#"
                className="text-xs font-medium text-blue-600 dark:text-gray-400 "
              >
                UI Design
              </a>
              <h2 className="mt-2 mb-4 text-xl font-semibold text-gray-600 dark:text-gray-300 ">
          ...
          <div className="grid grid-cols-1 mb-6 md:grid-cols-[30%,1fr] border-gray-200 border-b dark:border-gray-700 pb-4 gap-4">
            <div>
              <img
                src="https://i.postimg.cc/zvvjVj6Z/pexels-george-dolgikh-1326947.jpg"
                alt=""
              ...
              <div className="flex items-center justify-between ">
                ...
                >
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="w-6 h-6 bi bi-box-arrow-up"
                    viewBox="0 0 16 16"
                  >
                    <path
                      fillRule="evenodd"
